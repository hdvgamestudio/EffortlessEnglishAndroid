...
public class GvLessonAdapter extends ArrayAdapter<ItemsLesson>{

	Activity activity;
	ArrayList<ItemsLesson> listSrc;
	
	public GvLessonAdapter(Activity activity, int resource, ArrayList<ItemsLesson> listSrc) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		textView.setText(listSrc.get(position).getTitleLesson());
